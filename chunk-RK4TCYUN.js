import{c as g,h as f}from"./chunk-QUG5WU3S.js";import{La as s,W as l,Za as d,da as r,db as p,eb as c,ka as o,pb as m,qb as u,wb as h}from"./chunk-CWCG2WSJ.js";var T=(()=>{let a=class a{constructor(){this.id="",this.Defaultvalue="",this.value="",this.name="",this.editorChange=new o;let e=new Date;this.id="editor-"+e.getTime()+Math.floor(Math.random()*1e3)}ngAfterViewInit(){tinymce.get(this.name)||tinymce.init({selector:"."+this.id,height:300,plugins:"advlist autolink link image lists charmap print preview hr anchor pagebreak code textcolor colorpicker table image media emoticons wordcount fullscreen template",toolbar:"undo redo | bold italic | fontselect fontsizeselect | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | table | image | media | emoticons | wordcount | fullscreen | template",font_formats:"Figtree=Figtree, sans-serif; Red Hat Display=Red Hat Display, Arial=arial,helvetica,sans-serif; Times New Roman=times new roman,times; Courier New=courier new,courier; Verdana=verdana,geneva,sans-serif;",templates:[{title:"Two Column Layout",description:"A two-column layout with text on the left and an image on the right.",content:`
